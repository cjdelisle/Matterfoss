...
func TestConfigDefaultIncidentManagementPluginState(t *testing.T) {
	t.Run("should not enable IncidentManagement plugin by default on enterprise-ready builds", func(t *testing.T) {
...
func TestConfigDefaultChannelExportPluginState(t *testing.T) {
	t.Run("should not enable ChannelExport plugin by default on enterprise-ready builds", func(t *testing.T) {
		BuildEnterpriseReady = "true"
		c1 := Config{}
		c1.SetDefaults()
